...
Standalone Neovim configuration built with
[nvf](https://github.com/NotAShelf/nvf). Replaces the old
[nixvim](https://github.com/nix-community/nixvim) config from `personal_nixos`.
